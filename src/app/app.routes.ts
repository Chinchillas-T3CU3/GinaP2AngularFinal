...
import { FormularioFinancieroComponent } from './formulario-financiero/formulario-financiero.component';
...
export const routes: Routes = [
    ...
    {path:"financiero", component:FormularioFinancieroComponent} ,
