...
@Component({
  selector: 'app-formulario-financiero',
  ...
  templateUrl: './formulario-financiero.component.html',
  styleUrl: './formulario-financiero.component.css'
})
export class FormularioFinancieroComponent {
